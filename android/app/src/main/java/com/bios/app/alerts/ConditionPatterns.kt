...
object ConditionPatterns {
    ...
    val infectionOnset = ConditionPattern(
        ...
        // #189 gate: triad normative in pregnancy/postpartum (SepsisScreen + respiratoryInfection still cover acute).
    ...
    val sleepDisruption = ConditionPattern(
        ...
        // #189 gate: fragmentation physiologic in T3/postpartum; SleepApneaPattern still covers apnea.
        excludedStates = PhysiologyState.PREGNANCY + setOf(PhysiologyState.POSTPARTUM),
    )
    ...
    val overtraining = ConditionPattern(
        ...
        // #189 gate (defensive): same triad matches normal pregnancy/postpartum regardless of training load.
        excludedStates = PhysiologyState.PREGNANCY + setOf(PhysiologyState.POSTPARTUM),
    )
    ...
    val metabolicDrift = ConditionPattern(
        ...
        // #189 gate: GDM uses own TIR target (63–140); GDM-aware screen tracked as follow-up.
        excludedStates = PhysiologyState.PREGNANCY + setOf(PhysiologyState.POSTPARTUM),
    )
    ...
    val cardiorespiratoryDeconditioning = ConditionPattern(
        ...
        // #189 gate: T3/postpartum activity drop is physiologic; PPCM screen is postpartum-tuned replacement.
        excludedStates = PhysiologyState.PREGNANCY + setOf(PhysiologyState.POSTPARTUM),
    )
    ...
    val chronicInflammation = ConditionPattern(
        ...
        // #189 gate: pregnancy is normatively inflammatory; biomarker hsCRP patterns still fire.
        excludedStates = PhysiologyState.PREGNANCY + setOf(PhysiologyState.POSTPARTUM),
    )
    ...
    val recoveryDeficit = ConditionPattern(
        ...
        // #189 gate: HRV↓+sleep↓+RHR↑ is normal pregnancy/postpartum; manifesto-clean to stay silent.
        excludedStates = PhysiologyState.PREGNANCY + setOf(PhysiologyState.POSTPARTUM),
    )
    ...
    val menstrualCycleAnomaly = ConditionPattern(
        ...
        // #189 gate (defensive): BBT cycle abolished in pregnancy/postpartum.
        excludedStates = PhysiologyState.PREGNANCY + setOf(PhysiologyState.POSTPARTUM),
    )
