...
object ConditionPatterns {
    ...
    val menstrualCycleAnomaly = ConditionPattern(
        ...
        // menopausal transition. Flagging it as anomaly in peri/post-
        // menopause owners would be exactly the kind of normative
        // misread audit gap §2.12 calls out (#209).
        excludedStates = PhysiologyState.MENOPAUSE_TRANSITION
    )
