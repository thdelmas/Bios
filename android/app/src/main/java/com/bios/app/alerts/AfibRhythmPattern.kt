...
object AfibRhythmPattern {
    ...
    val paroxysmalAfibScreen = ConditionPattern(
        ...
        references = listOf(
            ...
            "Somers VK et al. (2008) — Sleep apnea and cardiovascular disease (AHA/ACC scientific statement) — untreated obstructive sleep apnea is a known upstream driver of atrial fibrillation; see SleepApneaPattern.sleepApneaScreen for the OSA screening pathway"
        ),
